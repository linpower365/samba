 ...
 */
UI32_T L_CIRLST_DoOperationAndMoveHead (L_CIRLST_List_T clist, UI8_T *end_p, void *func(UI32_T *msg_p, void *cookie), void *cookie)
{
    List_T  *list = (List_T*)clist;
    UI32_T  *ptr;
	UI32_T   ret  = 0;
 ...
 *               be smaller than record_len (so record_len must larger then 4 bytes).
 */
UI32_T L_CIRLST_ShMem_DoOperationAndMoveHead (L_CIRLST_ShMem_List_T *list, UI8_T *end_p, void *func(UI32_T *msg_p, void *cookie), void *cookie)
{
    UI32_T  end;
    UI32_T  *ptr;
	UI32_T  ret  = 0;
